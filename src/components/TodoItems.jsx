...
import { markAllCompleted, markCompleted, markIncompleted, removeTdo, toggleTodo } from "./Redux/Action/action";
  ...
  return (
    <li className="flex flex-col md:flex-row sm:items-center justify-between border-b-2 py-2 gap-4">
      ...
      <div className="flex space-x-3 ml-8">
        ...
        >
          {
            todo.completed ? <BsToggle2Off /> : <BsToggleOn />
          }
        </button>
        <button 
        onClick={() => dispatch(removeTdo(index))}
